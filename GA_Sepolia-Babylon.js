...
const CHAINLINK_ADDRESS = '0x779877A7B0D9E8603169DdbD7836e478b4624789'; // baseToken variable
...
async function pollPacketHash(txHash, retries = 30, intervalMs = 10000) {
    const headers = {
...
async function sendFromWallet(walletInfo, maxTransaction) {
    ...
    let shouldProceed;
    try {
        shouldProceed = await checkBalanceAndApprove(wallet, CHAINLINK_ADDRESS, contractAddress);
    } catch (error) {
    ...
    const chainlinkAddressHex = CHAINLINK_ADDRESS.slice(2).toLowerCase();
    const channelId = 8;
    ...
    for (let i = 1; i <= maxTransaction; i++) {
        ...
        const operand = '' +
            addressHex +
            '' +
            chainlinkAddressHex +
            '';
        const instruction = {
            version: 0,
            opcode: 2,
            operand,
...
async function main() {
    ...
    logger.loading(`Sending ${maxTransaction} Transaction Sepolia to Babylon Testnet from ${walletInfo.name || 'Unnamed'}`);
